    ...
    <div className='w-1/2 h-fit flex flex-col text-right gap-3'>
        ...
        <div className='w-full aspect-[3/2] bg-white flex flex-col gap-5 p-5 rounded-lg shadow-shadowBtn text-left'>
            ...
            <div className='flex flex-col justify-between gap-3'>
                ...
                <span className=''>
                History made! Team India celebrates a monumental victory in the Thomas Cup, Thomas Cup, showcasing skill, determination, and showcasing skill, determination, and...
                </span>
