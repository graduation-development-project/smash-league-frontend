...
export const simpleBracket: Match[] = [
  {
    ...
    participants: [
      ...
      {
        id: 'e7fe8889-13e8-46f7-8515-3c9d89c07b2a',
        resultText: 'DRAW',
        isWinner: true,
        status: 'PLAYED',
        name: 'trungson',
...
export const simpleTeamBracket: Match[] = [
  {
    id: 19874,
    name: 'Final - Match',
    nextMatchId: null,
