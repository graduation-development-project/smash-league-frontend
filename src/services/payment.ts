...
export const rejectPaymentAPI = async (transactionId: string | null, accessToken: string) => {
    try {
...
export const acceptPaymentAPI = async (transactionId: string | null, accessToken: string) => {
    try {
        const response = await axios.get(
